...
// the rate limiter's shared counter store and the geocode cache — both need state that
// survives per-pod, not per-process memory, once this service runs more than one replica.
class RedisManager {
