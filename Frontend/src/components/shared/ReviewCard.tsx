          ...
          <div className="relative flex-shrink-0">
            {customerReview.reviewer.imageUrl ? (
              <img
                ...
                className="w-12 h-12 rounded-full object-cover border-2 border-orange-400/50 group-hover:border-orange-400/70 transition-colors duration-200"
              />
            ) : (
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-orange-500/20 to-blue-500/20 backdrop-blur-sm flex items-center justify-center border-2 border-orange-400/50 group-hover:border-orange-400/70 transition-colors duration-200">
            ...
            {/* Provider Badge */}
            <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-orange-500/50 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <div className="text-xs text-orange-300 font-medium mb-1">Service Provider</div>
            ...
            <div className="flex items-center justify-between text-xs text-gray-500">
              <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-orange-500/20 text-orange-300 border border-orange-400/30">
