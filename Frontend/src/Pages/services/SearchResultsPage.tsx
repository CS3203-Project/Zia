      ...
      <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {sortedResults.length === 0 ? (
          <div className="text-center py-12">
            ...
            <Link
              to="/services"
              className="inline-flex items-center px-4 py-2 bg-orange-50 hover:bg-orange-100 text-gray-900 rounded-lg border border-gray-200 hover:border-gray-300 transition-all duration-200"
            >
              Browse All Services
            </Link>
          </div>
      ...
      <div className={`flex ${viewMode === 'list' ? 'space-x-4' : 'flex-col'}`}>
        ...
        <div className={`flex-shrink-0 ${viewMode === 'list' ? 'w-24 h-24' : 'w-full h-48'}`}>
          {service.images && service.images.length > 0 ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-blue-600/20 to-orange-600/20 rounded-lg flex items-center justify-center">
        ...
        <div className={`flex-1 ${viewMode === 'list' ? '' : 'mt-4'}`}>
          <div className="flex items-start justify-between mb-2">
            <h3 className="text-lg font-semibold text-gray-900 group-hover:text-blue-300 transition-colors line-clamp-2">
              {service.title}
            </h3>
            {service.similarity && (
