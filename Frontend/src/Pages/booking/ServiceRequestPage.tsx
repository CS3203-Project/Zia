...
const ServiceRequestPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white text-gray-900 pt-20 pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-sm rounded-2xl p-8 backdrop-blur-xl border border-gray-200">
          <div className="flex justify-between items-center mb-8">
            ...
            <button
              ...
              className="px-4 py-2 bg-orange-500 hover:bg-orange-600 text-gray-900 rounded-lg font-medium border border-gray-200 hover:border-gray-300 shadow-lg transition-all duration-300"
            >
          ...
          {formVisible && (
            <div className="mb-8 bg-gray-50 rounded-xl p-6 border border-gray-200">
              <h2 className="text-xl font-bold mb-4 text-gray-900">Create New Service Request</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-gray-900 placeholder-dark-muted focus:outline-none focus:ring-2 focus:ring-orange-500/20"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-dark-muted mb-1">
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-500 hover:to-blue-700 text-gray-900 rounded-lg font-medium border border-blue-700 hover:border-blue-600 shadow-lg transition-all duration-300 disabled:opacity-50"
                  >
          ...
          <div>
            <h2 className="text-xl font-semibold mb-4 text-gray-900">Your Requests</h2>
            {loading && !formVisible ? (
              ...
              <div className="space-y-4">
                {serviceRequests.map((request) => (
                  <div
                    key={request.id}
                    className="bg-gray-50 rounded-lg p-6 border border-gray-200 transition-all duration-300 hover:bg-orange-50 hover:border-gray-200"
                  >
