    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white text-gray-900 pt-20 pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white shadow-sm rounded-2xl p-8 backdrop-blur-xl border border-gray-200">
          ...
          {serviceRequest && (
            <div className="mb-8">
              <h1 className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent mb-4">
          ...
          {/* Matching Services */}
          <div>
            <h2 className="text-xl font-semibold mb-4 text-gray-900">Matching Services</h2>
            {loading ? (
                  ...
                  >
                    ...
                    <div className="flex space-x-2 mt-4">
                      ...
                      <Link
                        ...
                        className="px-3 py-1.5 bg-gradient-to-r from-orange-600/30 to-orange-800/30 hover:from-orange-500/40 hover:to-orange-700/40 text-orange-400 hover:text-orange-300 rounded-lg text-sm font-medium border border-orange-800/50 hover:border-orange-700/60 transition-all duration-300"
                      >
                        View Provider
                      </Link>
                    </div>
                  ...
                  <div className="flex justify-center mt-8">
                    <nav className="flex items-center space-x-1">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg text-sm bg-gray-50 border border-gray-200 hover:bg-orange-50 text-gray-900/90 hover:text-gray-900 disabled:opacity-50 disabled:hover:bg-gray-50 disabled:hover:text-gray-900/90 transition-all duration-300"
                      >
                        Previous
                      </button>
                      ...
                      {Array.from({ length: matchingResult.pagination.pages }, (_, i) => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-sm ${
                            currentPage === i + 1
                              ? 'bg-orange-100 border border-white/40 text-gray-900'
                              : 'bg-gray-50 border border-gray-200 hover:bg-orange-50 text-gray-900/90 hover:text-gray-900'
