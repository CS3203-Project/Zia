                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3.5 bg-gray-50 border rounded-xl text-gray-900 placeholder-gray-400 focus:bg-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 ${
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-12 pr-11 py-3.5 bg-gray-50 border rounded-xl text-gray-900 placeholder-gray-400 focus:bg-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 ${
                      ...
                      <div className="absolute z-20 w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-xl max-h-48 overflow-y-auto">
                        {sriLankanCities
                          ...
                          .map((city, i) => (
                            <button
                              key={i}
                              type="button"
                              className="w-full text-left px-4 py-2.5 hover:bg-orange-50 transition-colors duration-150 first:rounded-t-xl last:rounded-b-xl text-gray-900 text-sm"
                              onClick={() => {
                        ...
                        {sriLankanCities.filter((c) => c.toLowerCase().includes(formData.location.toLowerCase())).length === 0 &&
                          formData.location.length > 0 && (
                            <div className="px-4 py-2.5 text-gray-400 text-sm">No matching locations found</div>
                          )}
                      </div>
                    )}
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-200 hover:border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:bg-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
